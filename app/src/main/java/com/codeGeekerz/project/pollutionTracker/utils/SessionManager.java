...
import com.codeGeekerz.project.pollutionTracker.LoginActivity;
...
public class SessionManager {
    ...
    public static final String STATION_LIST = "selectedStations";
    ...
    public HashSet<String> getStationsList() {
        return (HashSet<String>) pref.getStringSet(STATION_LIST, new HashSet<String>());
    }
